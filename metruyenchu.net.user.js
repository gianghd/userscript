// ==UserScript==
// @name            MeTruyen downloader
// @name:vi         MeTruyen downloader
// @namespace       http://tampermonkey.net/
// @description     Tải truyện từ MeTruyen định dạng EPUB.
// @description:vi  Tải truyện từ MeTruyen định dạng EPUB.
// @version         1
// @icon            https://i.imgur.com/FQY8btq.png
// @author          FixBug
// @match           https://metruyenchu.net/*
// @match           https://truyenchu.vn/*
...
(function ($, window, document) {
  ...
  function getContent() {
    ...
    pathname = lastChar != '/' ? pathname + '/' : pathname;
    $.get(pathname + chapId + '/')
  ...
  var pageName = document.title,
    ...
    credits =
      ...
      referrer +
      '">metruyenchu.net</a></p><p>Userscript được viết bởi: FixBug</p>',
    jepub;
  ...
  $download.one('click contextmenu', function (e) {
    ...
    document.title = '[...] Vui lòng chờ trong giây lát';
        ...
        $.get('/api/services/chapter-option', {
          type: 'chapter_option',
          data: $novelId.val(),
         })
          .done(function (data) {
